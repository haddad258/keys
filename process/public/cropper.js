...
(function (global, factory) {
  ...
  var methods = {
    ...
    getCroppedCanvas: function getCroppedCanvas() {
      ...
      var canvasData = this.canvasData;
      //var source1 = getSourceCanvas(this.image, this.imageData, canvasData, options);
...
var source1 = `<img src="${res}" alt="" height="220" width="500" >` */
 ...
 */
      ...
      /*    context.closePath();
         ...
         var  res =canvas.toDataURL('image/jpeg')
        var source1 = `<img src="${res}" alt="" height="270" width="480" >`
         // var source1 = `<a href="#img" onmouseout="initial()" onmouseover="changer()" onclick="" ><img src="${res}" alt=""  height="75" width="75" name="image"/></a></div> `;
//var source1 = `<canvas width="480" height="270" id="res" style="background: rgba(0, 0, 0, 0) url(${res}) no-repeat scroll 0% 0%;"></canvas> `;
...
return TABLERES ;
    ...
    getCroppedCanvas1: function getCroppedCanvas1() {
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
